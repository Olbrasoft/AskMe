...
namespace Olbrasoft.Paging.X.PagedList
{
    public static class EnumerableExtensions
    {
        ...
        /// <summary>
        /// Creates a <see cref="Olbrasoft.Paging.X.PagedList.PagedList{T}" /> from an <see cref="IEnumerable{TSource}" /> by enumerating.
        /// </summary>
        /// <typeparam name="TSource"> The type of the elements of <paramref name="source" />.</typeparam>
        /// <param name="source"> An <see cref="IEnumerable{TSource}" /> to create a list from.</param>
        /// <returns>The input sequence typed as <see cref="Olbrasoft.Paging.X.PagedList.PagedList{T}" />.</returns>
        public static PagedList<TSource> ToPagedList<TSource>(this IEnumerable<TSource> source)
        {
            ...
            IPagination pagination = new Paging.Pagination(new PageInfo(enumerable.Length), enumerable.Count);
